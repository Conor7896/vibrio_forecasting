...
avg_val_auprc_18s_0 <- mean(val_auprcs)
avg_test_auprc_18s_0 <- mean(test_auprcs)
avg_test_rocauc_18s_0 <- mean(test_roc_aucs, na.rm = TRUE)
...
avg_val_auprc_18s_1 <- mean(val_auprcs)
avg_test_auprc_18s_1 <- mean(test_auprcs)
avg_test_rocauc_18s_1 <- mean(test_roc_aucs, na.rm = TRUE)
...
avg_val_auprc_18s_2 <- mean(val_auprcs)
avg_test_auprc_18s_2 <- mean(test_auprcs)
avg_test_rocauc_18s_2 <- mean(test_roc_aucs, na.rm = TRUE)
...
avg_val_auprc_18s_3 <- mean(val_auprcs)
avg_test_auprc_18s_3 <- mean(test_auprcs)
avg_test_rocauc_18s_3 <- mean(test_roc_aucs, na.rm = TRUE)
...
avg_val_auprc_18s_4 <- mean(val_auprcs)
avg_test_auprc_18s_4 <- mean(test_auprcs)
avg_test_rocauc_18s_4 <- mean(test_roc_aucs, na.rm = TRUE)
...
avg_val_auprc_18s_5 <- mean(val_auprcs)
avg_test_auprc_18s_5 <- mean(test_auprcs)
avg_test_rocauc_18s_5 <- mean(test_roc_aucs, na.rm = TRUE)
...
avg_val_auprc_18s_6 <- mean(val_auprcs)
avg_test_auprc_18s_6 <- mean(test_auprcs)
avg_test_rocauc_18s_6 <- mean(test_roc_aucs, na.rm = TRUE)
...
avg_val_auprc_18s_7 <- mean(val_auprcs)
avg_test_auprc_18s_7 <- mean(test_auprcs)
avg_test_rocauc_18s_7 <- mean(test_roc_aucs, na.rm = TRUE)
...
results_manual_rf_18s <- test_data %>%
  mutate(
...
# --- Confusion Matrix ---
confusion_matrix_rf_18s <- table(
  Predicted = results_manual_rf_18s$Predicted_Class,
  Actual = results_manual_rf_18s$Actual
)

cat("\n📌 Confusion Matrix (Random Forest):\n")
print(confusion_matrix_rf_18s)

# --- Sanity check output
head(weekly_summary_rf_18s)
...
avg_val_auprc_18s_8 <- mean(val_auprcs)
avg_test_auprc_18s_8 <- mean(test_auprcs)
avg_test_rocauc_18s_8 <- mean(test_roc_aucs, na.rm = TRUE)
...
avg_val_auprc_18s_9 <- mean(val_auprcs)
avg_test_auprc_18s_9 <- mean(test_auprcs)
avg_test_rocauc_18s_9 <- mean(test_roc_aucs, na.rm = TRUE)
...
avg_val_auprc_18s_10 <- mean(val_auprcs)
avg_test_auprc_18s_10 <- mean(test_auprcs)
avg_test_rocauc_18s_10 <- mean(test_roc_aucs, na.rm = TRUE)
...
# write.csv(
#   top_50_otus_0,
#   "data_all/16s_18s_time_lag_predictors/18s_predictors_time_lag_0.csv",
#   row.names = TRUE
# )
# 
# write.csv(
#   top_50_otus_1,
#   "data_all/16s_18s_time_lag_predictors/18s_predictors_time_lag_1.csv",
#   row.names = TRUE
# )
# 
# write.csv(
#   top_50_otus_2,
#   "data_all/16s_18s_time_lag_predictors/18s_predictors_time_lag_2.csv",
#   row.names = TRUE
# )
# write.csv(
#   top_50_otus_3,
#   "data_all/16s_18s_time_lag_predictors/18s_predictors_time_lag_3.csv",
#   row.names = TRUE
# )
# write.csv(
#   top_50_otus_4,
#   "data_all/16s_18s_time_lag_predictors/18s_predictors_time_lag_4.csv",
#   row.names = TRUE
# )
# write.csv(
#   top_50_otus_5,
#   "data_all/16s_18s_time_lag_predictors/18s_predictors_time_lag_5.csv",
#   row.names = TRUE
# )
# write.csv(
#   top_50_otus_6,
#   "data_all/16s_18s_time_lag_predictors/18s_predictors_time_lag_6.csv",
#   row.names = TRUE
# )
# write.csv(
#   top_50_otus_7,
#   "data_all/16s_18s_time_lag_predictors/18s_predictors_time_lag_7.csv",
#   row.names = TRUE
# )
# write.csv(
#   top_50_otus_8,
#   "data_all/16s_18s_time_lag_predictors/18s_predictors_time_lag_8.csv",
#   row.names = TRUE
# )
# write.csv(
#   top_50_otus_9,
#   "data_all/16s_18s_time_lag_predictors/18s_predictors_time_lag_9.csv",
#   row.names = TRUE
# )
# write.csv(
#   top_50_otus_10,
#   "data_all/16s_18s_time_lag_predictors/18s_predictors_time_lag_10.csv",
#   row.names = TRUE
# )
