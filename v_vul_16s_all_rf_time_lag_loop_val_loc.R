...
avg_val_auprc_16s_all_0 <- mean(val_auprcs)
avg_test_auprc_16s_all_0 <- mean(test_auprcs)
avg_test_rocauc_16s_all_0 <- mean(test_roc_aucs, na.rm = TRUE)


cat("\n📊 Validation AUPRCs (by pair):", round(val_auprcs, 3), "\n")
cat("📈 Average Validation AUPRC:", round(avg_val_auprc_16s_all_0, 3), "\n")
cat("🧪 Average Test AUPRC:", round(avg_test_auprc_16s_all_0, 3), "\n")
...
avg_val_auprc_16s_all_1 <- mean(val_auprcs)
avg_test_auprc_16s_all_1 <- mean(test_auprcs)
avg_test_rocauc_16s_all_1 <- mean(test_roc_aucs, na.rm = TRUE)


cat("\n📊 Validation AUPRCs (by pair):", round(val_auprcs, 3), "\n")
cat("📈 Average Validation AUPRC:", round(avg_val_auprc_16s_all_1, 3), "\n")
cat("🧪 Average Test AUPRC:", round(avg_test_auprc_16s_all_1, 3), "\n")
cat("⚠️ Skipped validation pairs:", paste(skipped_locs, collapse = ", "), "\n")
...
avg_val_auprc_16s_all_2 <- mean(val_auprcs)
avg_test_auprc_16s_all_2 <- mean(test_auprcs)
avg_test_rocauc_16s_all_2 <- mean(test_roc_aucs, na.rm = TRUE)
...
avg_val_auprc_16s_all_3 <- mean(val_auprcs)
avg_test_auprc_16s_all_3 <- mean(test_auprcs)
avg_test_rocauc_16s_all_3 <- mean(test_roc_aucs, na.rm = TRUE)
...
avg_val_auprc_16s_all_4 <- mean(val_auprcs)
avg_test_auprc_16s_all_4 <- mean(test_auprcs)
avg_test_rocauc_16s_all_4 <- mean(test_roc_aucs, na.rm = TRUE)
...
avg_val_auprc_16s_all_5 <- mean(val_auprcs)
avg_test_auprc_16s_all_5 <- mean(test_auprcs)
avg_test_rocauc_16s_all_5 <- mean(test_roc_aucs, na.rm = TRUE)
...
avg_val_auprc_16s_all_6 <- mean(val_auprcs)
avg_test_auprc_16s_all_6 <- mean(test_auprcs)
avg_test_rocauc_16s_all_6 <- mean(test_roc_aucs, na.rm = TRUE)
...
avg_val_auprc_16s_all_7 <- mean(val_auprcs)
avg_test_auprc_16s_all_7 <- mean(test_auprcs)
avg_test_rocauc_16s_all_7 <- mean(test_roc_aucs, na.rm = TRUE)
...
avg_val_auprc_16s_all_8 <- mean(val_auprcs)
avg_test_auprc_16s_all_8 <- mean(test_auprcs)
avg_test_rocauc_16s_all_8 <- mean(test_roc_aucs, na.rm = TRUE)
...
avg_val_auprc_16s_all_9 <- mean(val_auprcs)
avg_test_auprc_16s_all_9 <- mean(test_auprcs)
avg_test_rocauc_16s_all_9 <- mean(test_roc_aucs, na.rm = TRUE)
...
results_manual_rf_16s_all <- test_data %>%
  mutate(
...
# --- Confusion Matrix ---
confusion_matrix_rf_16s_all <- table(
  Predicted = results_manual_rf_16s_all$Predicted_Class,
  Actual = results_manual_rf_16s_all$Actual
)

cat("\n📌 Confusion Matrix (Random Forest):\n")
print(confusion_matrix_rf_16s_all)

# --- Sanity check output
head(weekly_summary_rf_16s_all)
...
avg_val_auprc_16s_all_10 <- mean(val_auprcs)
avg_test_auprc_16s_all_10 <- mean(test_auprcs)
avg_test_rocauc_16s_all_10 <- mean(test_roc_aucs, na.rm = TRUE)
...
# pr_value_values <- c(pr_value_0, pr_value_1, pr_value_2, pr_value_3, 
#                      pr_value_4, pr_value_5, pr_value_6, pr_value_7, pr_value_8, pr_value_9, pr_value_10)
# 
# # Create a data frame
# pr_value_data <- data.frame(
#   Model = factor(0:10),  # X-axis (model indices 0-9)
...
#   ggtitle("16S Random Forest Model Performance Time-Lag 0-10") +
#   xlab("Time-lag") +
#   ylab("AUPRC") +
#   ylim(0.3, 0.8) +  
#   theme_minimal() +
...
# 
# # Store AUC values in a vector
# auc_value_values <- c(auc_value_0, auc_value_1, auc_value_2, auc_value_3, 
#                      auc_value_4, auc_value_5, auc_value_6, auc_value_7, auc_value_8, auc_value_9, auc_value_10)
# 
# # Create a data frame
...
# write.csv(
#   top_50_otus_0,
#   "data_all/16s_18s_time_lag_predictors/16s_predictors_time_lag_0.csv",
#   row.names = TRUE
# )
# 
# write.csv(
#   top_50_otus_1,
#   "data_all/16s_18s_time_lag_predictors/16s_predictors_time_lag_1.csv",
#   row.names = TRUE
# )
# 
# write.csv(
#   top_50_otus_2,
#   "data_all/16s_18s_time_lag_predictors/16s_predictors_time_lag_2.csv",
#   row.names = TRUE
# )
# write.csv(
#   top_50_otus_3,
#   "data_all/16s_18s_time_lag_predictors/16s_predictors_time_lag_3.csv",
#   row.names = TRUE
# )
# write.csv(
#   top_50_otus_4,
#   "data_all/16s_18s_time_lag_predictors/16s_predictors_time_lag_4.csv",
#   row.names = TRUE
# )
# write.csv(
#   top_50_otus_5,
#   "data_all/16s_18s_time_lag_predictors/16s_predictors_time_lag_5.csv",
#   row.names = TRUE
# )
# write.csv(
#   top_50_otus_6,
#   "data_all/16s_18s_time_lag_predictors/16s_predictors_time_lag_6.csv",
#   row.names = TRUE
# )
# write.csv(
#   top_50_otus_7,
#   "data_all/16s_18s_time_lag_predictors/16s_predictors_time_lag_7.csv",
#   row.names = TRUE
# )
# write.csv(
#   top_50_otus_8,
#   "data_all/16s_18s_time_lag_predictors/16s_predictors_time_lag_8.csv",
#   row.names = TRUE
# )
# write.csv(
#   top_50_otus_9,
#   "data_all/16s_18s_time_lag_predictors/16s_predictors_time_lag_9.csv",
#   row.names = TRUE
# )
# write.csv(
#   top_50_otus_10,
#   "data_all/16s_18s_time_lag_predictors/16s_predictors_time_lag_10.csv",
#   row.names = TRUE
# )
# 
# 
...
#write.csv(
#  plot_df,
#  "data_all/excel_jmp_tables/plot_df.csv",
#  row.names = TRUE
#)
